...
class ConversationPageScreen extends GetWidget<ConversationPageController> {
  @override
                              ...
                              children: [
                                CustomAppBar(
                                    ...
                                    leading: AppbarImage(
                                        ...
                                        margin: getMargin(left: 27, bottom: 4),
                                        onTap: onTapClock4),
                                    title: Padding(
                                        padding: getPadding(left: 42),
                                        child: Text("lbl_felix_co".tr,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle.txtRobotoRegular30
                                                .copyWith(
